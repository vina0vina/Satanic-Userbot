TRUTH = [
    ...
    "Apabila kamu cewe bersedia kah untuk menjadi pacar owner ku @LeXcZ_Alok",
    ...
    "si @LeXcZ_Alok menurut ku dia ganteng, coba deh kamu chat, trus ajak pacaran hehe ⚠️WARNING ini khusus cewe ya!",
...
DARE = [
     ...
     "Bilang ke @LeXcZ_Alok bahwa dia ganteng",
]
